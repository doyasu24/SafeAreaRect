...
namespace SafeAreaRect.Screens
{
    public static class iOSScreenType
    {
        ...
        public static readonly iOSScreen iPhoneXPortrait = new iOSScreen(
            new Vector2Int(1125, 2436),
            new Rect(0, 102, 1125, 2202)
        );

        // iPhone X/XS/11 Pro Landscape
        public static readonly iOSScreen iPhoneXLandscape = new iOSScreen(
            new Vector2Int(2436, 1125),
            new Rect(132, 63, 2172, 1062)
        );

        // iPhone XR/11 Portrait
        public static readonly iOSScreen iPhoneXRPortrait = new iOSScreen(
            new Vector2Int(828, 1792),
            new Rect(0, 68, 828, 1636)
        );

        // iPhone XR/11 Landscape
        public static readonly iOSScreen iPhoneXRLandscape = new iOSScreen(
            new Vector2Int(1792, 828),
            new Rect(88, 42, 1616, 786)
        );

        // iPhone XS Max/11 Pro Max Portrait
        public static readonly iOSScreen iPhoneXSMaxPortrait = new iOSScreen(
            new Vector2Int(1242, 2688),
            new Rect(0, 102, 1242, 2454)
        );

        // iPhone XS Max/11 Pro Max Landscape
        public static readonly iOSScreen iPhoneXSMaxLandscape = new iOSScreen(
            new Vector2Int(2688, 1242),
            new Rect(132, 63, 2454, 1242)
        );

        public static iOSScreen Unknown() => new iOSScreen(
